  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttonView}>
            <Pressable style={styles.button} onPress={() => Alert.alert("Başarıyla Giriş yaptınız")}>
        ...
        <Text style={styles.footerText}>Hesabın yok mu?<Text style={styles.signup}>  Kaydol</Text></Text>
